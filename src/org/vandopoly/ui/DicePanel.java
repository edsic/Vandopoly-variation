...
public class DicePanel extends JPanel {
    ...
    public DicePanel(Dice dice) {
        ...
        int rightMargin = 175, topMargin = 0;
        ...
        NotificationManager.getInstance().addObserver(Notification.ROLL_DICE,
                this, "updateDice");
        NotificationManager.getInstance().addObserver(Notification.AI_ROLL_DICE,
                this, "updateAIDice");
            ...
            new Thread() {
                public void run() {
                    ...
                    //else if (dice.getNumInRowDoubles() < 3) {
                        ...
                        new MessagePopUp("Doubles. Roll again!", "", 22);
                        NotificationManager.getInstance().notifyObservers(Notification.DICE_ANIMATION_DONE, dice);
                    }
    ...
    public void updateAIDice(Object obj) {
        ...
        try {
            ...
            new Thread() {
                public void run() {
                    ...
                    try {
                        Thread.sleep(2000 + r1.nextInt(12) * 150);
                    } catch (InterruptedException e) {
