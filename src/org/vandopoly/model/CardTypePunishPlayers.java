 ...
 * @author Allie Mazzia
 */
public class CardTypePunishPlayers extends Card implements Serializable {

    private int amount_;
    final static long serialVersionUID = 244;

    public CardTypePunishPlayers() {
        message_ = "NONE";
        amount_ = 0;
    }

    public CardTypePunishPlayers(String message, int amount) {
        message_ = message;
        amount_ = amount;
    }
